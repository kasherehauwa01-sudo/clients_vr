...
assert_contains("backend/alembic/versions/20260826_0011_add_client_raw_email.py", "sa.inspect")
assert_contains("backend/alembic/versions/20260826_0012_add_raw_email_source_marker.py", "sa.inspect")
assert_not_contains("backend/alembic/versions/20260826_0012_add_raw_email_source_marker.py", r"UPDATE\s+clients")
assert_contains("backend/app/main.py", "приложение продолжит работу")
